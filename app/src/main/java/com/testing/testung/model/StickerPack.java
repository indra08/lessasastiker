...
public class StickerPack implements Parcelable {
    ...
    public String trayImageFileLink;
    public String sku;
    ...
    public StickerPack(String identifier, String name, String publisher, String trayImageFile,String trayImageFileLink, String publisherEmail, String publisherWebsite, String privacyPolicyWebsite, String licenseAgreementWebsite,String sku) {
        ...
        this.sku=sku;
        this.trayImageFileLink = trayImageFileLink;
    }
    ...
    protected StickerPack(Parcel in) {
        ...
        trayImageFileLink = in.readString();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(trayImageFileLink);
