package com.testing.testung.provider;
...
//monggo di coba mas
    //tak maem dulu mas kencot heheheh siap mas bro.... aku yo ngeleeeh.. ashiap
    // //apa tak ngopi lagi ke jogja sehari 1 malam aja..
    //butuh model ga, gampang itu mas buat long term butuh model cm foto aja. hahah
    //semoga ads sever mantul ini.. admob okeh siaap..aminn..coba dulu mas nanti kalo error paling dikit
    ...
    private Cursor getStickerPackInfo(@NonNull Uri uri, @NonNull List<StickerPack> stickerPackList) {
        ...
        for (StickerPack stickerPack : stickerPackList) {
            ...
            builder.add("https://play.google.com/store/apps/details?id=com.wastickerapps.love.story.uniquedev");
